...
#define sloht _p[8]
#define taummin _p[9]
#define taumdiff _p[10]
#define tauhmin _p[11]
#define tauhdiff _p[12]
#define ica _p[13]
#define gCa_LVAst _p[14]
#define m _p[15]
#define h _p[16]
#define eca _p[17]
#define mInf _p[18]
...
extern Memb_func* memb_func;
 ...
 "sloht_Ca_LVAst", "mV",
 "taummin_Ca_LVAst", "ms",
 "taumdiff_Ca_LVAst", "ms",
 "tauhmin_Ca_LVAst", "ms",
 "tauhdiff_Ca_LVAst", "ms",
 "ica_Ca_LVAst", "mA/cm2",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_LVAst /home/christoph/MMN_project/Capstone/x86_64/Ca_LVAst.mod\n");
...
static int  rates ( _threadargsproto_ ) {
 ...
 _lqt = pow( 2.3 , ( ( 34.0 - 21.0 ) / 10.0 ) ) ;
    mInf = 1.0000 / ( 1.0 + exp ( ( offma - v ) / sloma ) ) ;
   mTau = ( taummin + taumdiff / ( 1.0 + exp ( - ( offmt - v ) / slomt ) ) ) / _lqt ;
   hInf = 1.0000 / ( 1.0 + exp ( - ( offha - v ) / sloha ) ) ;
   hTau = ( tauhmin + tauhdiff / ( 1.0 + exp ( - ( offht - v ) / sloht ) ) ) / _lqt ;
     return 0; }
