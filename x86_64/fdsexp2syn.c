...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 FDSExp2Syn /home/christoph/MMN_project/Capstone/x86_64/fdsexp2syn.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 94 in file fdsexp2syn.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
